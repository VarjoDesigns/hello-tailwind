    ...
    return(
        <div className="content-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-24">
            <div className="relative overflow-hidden container mx-auto content-center justify-center">
                <h1 className="font-bold tracking-tighter text-2xl text-center text-indigo-900">Lorem ipsum</h1>
                ...
                <div className="flex justify-center py-2">
                    <button className="bg-pink-600 hover:bg-pink-500 text-white py-2 px-4 rounded-full">
                        Find out more
                    </button>
                </div>
